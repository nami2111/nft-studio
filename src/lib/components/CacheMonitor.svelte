...
<div class="cache-monitor p-4 bg-white border border-gray-200 rounded-lg shadow-sm">
	...
	<div class="mb-6">
		...
		<div class="grid grid-cols-2 md:grid-cols-4 gap-3">
			...
			<div class="bg-blue-50 p-3 rounded">
				...
				<div class="text-sm font-semibold text-blue-800">{metrics.memorySummary.byCache.imageBitmap}</div>
			</div>
			<div class="bg-green-50 p-3 rounded">
				<div class="text-xs text-green-500">ImageData</div>
				<div class="text-sm font-semibold text-green-800">{metrics.memorySummary.byCache.imageData}</div>
			</div>
			<div class="bg-purple-50 p-3 rounded">
				<div class="text-xs text-purple-500">ArrayBuffer</div>
				<div class="text-sm font-semibold text-purple-800">{metrics.memorySummary.byCache.arrayBuffer}</div>
			</div>
		</div>
	</div>
	...
	<!-- Overall Statistics -->
	<div class="mb-6">
		<h4 class="text-md font-medium text-gray-700 mb-2">Overall Performance</h4>
		<div class="grid grid-cols-2 md:grid-cols-4 gap-3">
			<div class="bg-gray-50 p-3 rounded">
			...
			<div class="bg-gray-50 p-3 rounded">
				...
				<div class="text-lg font-bold text-gray-800">{metrics.overall.totalHits.toLocaleString()}</div>
			</div>
			<div class="bg-gray-50 p-3 rounded">
				<div class="text-xs text-gray-500">Total Misses</div>
				<div class="text-lg font-bold text-gray-800">{metrics.overall.totalMisses.toLocaleString()}</div>
			</div>
			<div class="bg-gray-50 p-3 rounded">
				<div class="text-xs text-gray-500">Entries</div>
				<div class="text-lg font-bold text-gray-800">{metrics.overall.totalEntries.toLocaleString()}</div>
			</div>
		</div>
	</div>
	...
	<div class="space-y-4">
		<div>
			<h4 class="text-md font-medium text-gray-700 mb-2">ImageBitmap Cache</h4>
			<div class="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
				<div class="bg-blue-50 p-2 rounded">
					<span class="text-blue-600">Size:</span> {metrics.imageBitmap.currentEntries}/{metrics.imageBitmap.maxEntries}
				</div>
				<div class="bg-blue-50 p-2 rounded">
					<span class="text-blue-600">Memory:</span> {metrics.imageBitmap.currentSize >= 1024*1024
		...
		<div>
			<h4 class="text-md font-medium text-gray-700 mb-2">ImageData Cache</h4>
			<div class="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
				<div class="bg-green-50 p-2 rounded">
					<span class="text-green-600">Size:</span> {metrics.imageData.currentEntries}/{metrics.imageData.maxEntries}
				</div>
				<div class="bg-green-50 p-2 rounded">
					<span class="text-green-600">Memory:</span> {metrics.imageData.currentSize >= 1024*1024
		...
		<div>
			<h4 class="text-md font-medium text-gray-700 mb-2">ArrayBuffer Cache</h4>
			<div class="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
				<div class="bg-purple-50 p-2 rounded">
					<span class="text-purple-600">Size:</span> {metrics.arrayBuffer.currentEntries}/{metrics.arrayBuffer.maxEntries}
				</div>
				<div class="bg-purple-50 p-2 rounded">
					<span class="text-purple-600">Memory:</span> {metrics.arrayBuffer.currentSize >= 1024*1024
	...
	<div class="mt-4 pt-4 border-t border-gray-200">
		<div class="text-xs text-gray-500">
			<strong>Object URLs tracked:</strong> {metrics.memorySummary.objectUrls}
		</div>
